    ...
    <div class="content-wrapper error-wrapper-custom">
        <div class="error-card-custom">
            ...
            <div class="minecraft-hotel">
                ...
                <div class="sign-403">403</div>
            </div>

            <h1 class="error-title-text">Acceso denegado</h1>

            <p class="error-desc-text">
                No tienes permiso para acceder a esta sección. Si crees que es un error, contacta al administrador del sistema.
            </p>
            ...
            <span class="code-label">Error 403</span>
        </div>
    </div>
@endsection
