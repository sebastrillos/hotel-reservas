    ...
    <div class="content-wrapper error-wrapper-custom">
        <div class="error-card-custom">
            ...
            <div class="minecraft-hotel">
                <i class="fas fa-clock hotel-icon"></i>
                <div class="sign-419">419</div>
            </div>

            <h1 class="error-title-text">Tu sesión ha expirado</h1>

            <p class="error-desc-text">
                El tiempo de tu sesión venció o el token de seguridad ya no es válido. Por favor, recarga la página e intenta de nuevo.
            </p>
            ...
            <span class="code-label">Error 419</span>
        </div>
    </div>
@endsection
